...
echo ""
echo -e "${YELLOW}📝 Important: Your Lightsail IP is 44.204.243.42${NC}"
echo ""
echo "Next steps:"
echo "1. Create DNS A records in Route 53:"
echo "   - editessolutions.com → 44.204.243.42"
echo "   - www.editessolutions.com → 44.204.243.42"
echo "2. Upload website files to your Lightsail instance"
echo "3. Configure Nginx (see DEPLOYMENT.md for details)"
echo "4. Set up SSL certificate with Certbot"
echo ""
echo "📋 See DNS-SETUP.md for detailed DNS configuration steps"
echo ""
